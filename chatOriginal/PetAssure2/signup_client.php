...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    for ($i = 1; $i < 17; $i++) {
        if ($rand == $i) {
            $profile_pic = "images/profile_pics/defaults/$i.png";
        }
    }

    // Insert data into user table
    $sql_user = "INSERT INTO user (fname,nic, mobile, email, address,uname,password,district,role) VALUES ('$fname' ,'$nic','$mobile','$email','$address','$uname','$password','$district','client')";
    ...
    if (mysqli_query($con, $sql_user))
    {
        if ($password !== $confirm_password) {
            ...
            $sql_users = "INSERT INTO users ( first_name, last_name, username, email, password, signup_date, profile_pic, friend_array) VALUES ('$fname', '$lname', '$uname', '$email', '$password', '$date', '$profile_pic', ',')";
...
<div class="user-details"> 
    ...
    </div><div class="footerr" style=" z-index: -1; width: 100%;  margin-top: 810px;">
