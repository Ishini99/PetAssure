    ...
    <div class="posts" >
      <div class="product-card" id="product-card">
          ...
          <div class="product-details">
              ...
              <div class="not_change_on_hover">
                  <div class="product-quality">
                      <!-- <div class="input-chip active"> -->
                        <a href="./shelterbooking.php"> <button class="btn add-to-card">BOOK NOW</button></a>
                      </div>
              ...
              <div class="product-card" id="product-card">
                <img src="../Images/cage2.jpg" class="product-card-thumbnail-image">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img class="scale-down" src="./Images/cage.jpg">
                ...
                <div class="product-details">
                    <div id="hide_on_hover">
                        <p class="book-title">AAA Boarders</p>
                        <p class="author"></p>
                        <span class="rating"> 4.5
                              <p class="fa fa-star"></p> (124)
                        </span>
                    ...
                    <div class="product-card" id="product-card">
                      <img src="../Images/cage3.jpg" class="product-card-thumbnail-image">
                      <div class="swiper-container">
                          <div class="swiper-wrapper">
                              <div class="swiper-slide">
                                  <img class="scale-down" src="./Images/cage.jpg">
                      ...
                      <div class="product-details">
                          <div id="hide_on_hover">
                              <p class="book-title">Boarding Bois</p>
                              <p class="author"></p>
                              <span class="rating"> 4.5
                                    <p class="fa fa-star"></p> (124)
                              </span>
        ...
        <div class="product-card" id="product-card">
            <img src="./Images/cage1.jpg" class="product-card-thumbnail-image">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img class="scale-down" src="./Images/cage.jpg">
