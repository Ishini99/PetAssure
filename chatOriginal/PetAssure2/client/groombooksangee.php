...
if(isset($_POST['submit'])){
  ...
  $sql = "UPDATE `vetappointment` SET `userid`= {$_POST['userID']} WHERE appNo={$_POST['vetappointment']};";
...
<head>
    ...
    <link rel="stylesheet" href="style_appointments1.css">
    <link rel="stylesheet" href="groombooking.css">
...
<body class="body-scroller">
          ...
          <tbody>
            ...
            foreach ($rows as $row): ?>
              ...
              <tr class="active-row">
                ...
                <td>
                  <?php echo (isset($row['fname']) ? $row['fname'] : 'N/A'); ?>
                </td>
                ...
                <td><a href="?id=<?php echo $row['appNo'] ?>&uid=<?php echo $getUser?>"><button type="button" document.location='#id01'
                      class="button">Get
    ...
    <div id="id01" class="modal">
      ...
      <form class="modal-content animate" action="" method="post">
        ...
        WHERE vetappointment.appNo = $ap_id";
