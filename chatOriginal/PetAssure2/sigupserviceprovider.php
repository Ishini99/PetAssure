...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $sql_user = "INSERT INTO user (fname, lname, nic, mobile, role, email, address, uname, password, district) VALUES ('$fname', '$lname', '$nic', '$mobile', '$stype', '$email', '$address', '$uname', '$password', '$district')";
