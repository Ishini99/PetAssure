...
ON vetappointment.spid = serviceprovider.spid
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    ...
                    $sql = "SELECT vetappointment.appoDate, vetappointment.startTime, vetappointment.endTime, user.fname,user.mobile
                    FROM vetappointment
                    LEFT JOIN user ON vetappointment.userid = user.userid
                    INNER JOIN serviceprovider ON vetappointment.spid = serviceprovider.spid
                    WHERE serviceprovider.spid = '$spid'
                    ORDER BY vetappointment.appoDate DESC, vetappointment.startTime DESC"
                    ); ?>
...
if ($_POST) {  
    ...
    $sql = "INSERT INTO vetappointment (spid,appoDate,startTime,endTime) VALUES ('$spid','$appoDate','$startTime','$endTime');";
