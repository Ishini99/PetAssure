            ...
            <div class="dash-body">
                <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                    <tr>
                        ...
                        <td width="0.6%">
                            <p
                                style="font-size: 16px;color: rgb(119, 119, 119);padding: 0;margin: 2;text-align: right;">
                                Today's Date
                            </p>
                            <p class="heading-sub12"
                                style="padding: 0;font-size: 16px;color: black ; margin-right: -60px;">
                                <?php 
                        ...
                        <td width="2%">
                            <button class="btn-label"
                                style="display: flex;justify-content: center;align-items: center;"><img
                                    src="calendar.svg" width="40px"></button>
                        </td>
                        ...
                        <td colspan="4">
                            <div style="display: flex;margin-top: 40px;">
                                ...
                                <button class="login-btn btn-primary btn button-icon"
                                    ...
                                    style="width:auto;">Add a session</button>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <input type='checkbox' class='inputUncheck' name='foo'
                                                        value='bar' />
                                                    <script>
                                                ...
                                                <div style="display: flex;justify-content: center;">
                                                    <div class="abc">
                                                        <table width="80%"
                                                            ...
                                                            <tr>
                                                                <td class="label-td" colspan="2">
                                                                    <input type="date" name="appoDate"
                                                                        class="input-text" min="' . date('Y-m-d') . '"
                                                                        required><br>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="label-td" colspan="2">
                                                                    <input type="time" name="startTime"
                                                                        class="input-text" placeholder="Time"
                                                                        required><br>
                                                                </td>
                                                            </tr>
                                                            <td class="label-td" colspan="2">
