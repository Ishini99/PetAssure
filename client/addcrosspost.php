...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO pet_crossing (name,district,pet_variety ,address,price,description,image,email,phone_number,userid) values ('$name','$districts', '$pets', '$address', '$price', '$description', '$photo', '$email', '$phone', '$userid')";
  if (mysqli_query($con, $sql)) {
    header('Location: ./crossposts.php');
    die();
  ...
  <div class="page">
    ...
    <div class="page">
      ...
      <form action="#" method="post">
        <h2><u>Register Here for pet  Cross </u></h2>
        <div>
          <form action="">
