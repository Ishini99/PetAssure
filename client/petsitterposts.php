  ...
  <div class="content" style="margin-top: 70px">
    ...
    <div class="posts" >
      <div class="product-card" id="product-card">
          <img src="../images/petsit1.jpg" class="product-card-thumbnail-image">
          <div class="swiper-container">
              <div class="swiper-wrapper">
                  <div class="swiper-slide">
                      <img class="scale-down" src="../images/cage.jpg">
                  </div>
                  <div class="swiper-slide">
          ...
          <div class="product-details">
              <div id="hide_on_hover">
                  <p class="book-title">Ravindu petsitter</p>
                  <p class="author"></p>
              ...
              <div class="not_change_on_hover">
                  <div class="product-quality">
                      <!-- <div class="input-chip active"> -->
                        <a href="./petsitterbooking.php"> <button class="btn add-to-card">BOOK NOW</button></a>
                      </div>
              ...
              <div class="product-card" id="product-card">
                <img src="../images/petsit2.jpg" class="product-card-thumbnail-image">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img class="scale-down" src="../images/cage.jpg">
                ...
                <div class="product-details">
                    <div id="hide_on_hover">
                        <p class="book-title">Adam petsitter</p>
                        <p class="author"></p>
                        <span class="rating"> 4.5
                              <p class="fa fa-star"></p> (124)
                        </span>
                    ...
                    <div class="product-card" id="product-card">
                      <img src="../images/petsit3.jpg" class="product-card-thumbnail-image">
                      <div class="swiper-container">
                          <div class="swiper-wrapper">
                              <div class="swiper-slide">
                                  <img class="scale-down" src="../images/cage.jpg">
                      ...
                      <div class="product-details">
                          <div id="hide_on_hover">
                              <p class="book-title">Dog Companion</p>
                              <p class="author"></p>
                              <span class="rating"> 4.7
                                    <p class="fa fa-star"></p> (224)
                              </span>
                          </div>
                          <div id="show_on_hover">
                              <!-- <i class="material-icons heart">favorite</i> -->
                          ...
                          <div class="product-card" id="product-card">
                            <img src="../images/petsit4.jpg" class="product-card-thumbnail-image">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="scale-down" src="../images/cage.jpg">
                            ...
                            <div class="product-details">
                                <div id="hide_on_hover">
                                    <p class="book-title">DOG Home Boarders</p>
                                    <p class="author"></p>
                                    <span class="rating"> 4.5
                                          <p class="fa fa-star"></p> (124)
                                    </span>
                                ...
                                <div class="product-card" id="product-card">
                                  <img src="../images/cage.jpg" class="product-card-thumbnail-image">
                                  <div class="swiper-container">
                                      <div class="swiper-wrapper">
                                          <div class="swiper-slide">
                                              <img class="scale-down" src="../images/cage.jpg">
        ...
        <div class="product-card" id="product-card">
            ...
            <div class="product-details">
                ...
                <div class="not_change_on_hover">
                    <div class="product-quality">
                        <!-- <div class="input-chip active"> -->
                          <button class="btn add-to-card">BOOK NOW</button>
                        </div>
                        <!-- <div class="input-chip">
                            <!-- <input type="radio">Good  -->
                        </div>
