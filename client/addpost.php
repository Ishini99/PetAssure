...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO pet_selling (name,district,pet_variety ,address,price,description,image,email,phone_number,userid) values ('$name','$districts', '$pets', '$address', '$price', '$description', '$photo', '$email', '$phone', '$userid')";
  if (mysqli_query($con, $sql)) {
    header('Location: ./saleposts.php');
    die();
