...
$sql = "SELECT * FROM user WHERE role IN ( 'petboarding')";
...
<body>
    ...
    <div>
        ...
        <div class="posts">
            ...
            <?php
            $sql = "SELECT user.*, MIN(boardingimage.imgId) AS first_image_id
 FROM user
 INNER JOIN boardingimage ON user.role = 'petboarding' AND user.userid = boardingimage.uid
 GROUP BY user.userid";
            ...
            if ($result->num_rows > 0) {
                while ($row1 = $result->fetch_assoc()) {
                    ...
                    $image_sql = "SELECT * FROM boardingimage WHERE imgId = " . $row1['first_image_id'];
                    ...
                    <div class="product-card" id="product-card">
                        <img src="./../pet_boarding/boarding_img/<?php echo $image_row['image'] ?>"
                        ...
                        <div class="product-details">
                            ...
                            <div class="not_change_on_hover">
                                <div class="product-quality">
                                    ...
                                    <a href="boardingbook.php?uid=<?php echo $row1['userid'] ?>"> <button
