...
$sql = "SELECT * FROM user WHERE role IN ( 'veterinarian')";
...
<body>
    ...
    <div>
        ...
        <div class="posts">
            ...
            <?php
            $sql = "SELECT user.*, MIN(vetimage.imgId) AS first_image_id
 FROM user
 INNER JOIN vetimage ON user.role = 'veterinarian' AND user.userid = vetimage.uid
 GROUP BY user.userid";
            ...
            if ($result->num_rows > 0) {
                while ($row1 = $result->fetch_assoc()) {
                    ...
                    $image_sql = "SELECT * FROM vetimage WHERE imgId = " . $row1['first_image_id'];
                    ...
                    <div class="product-card" id="product-card">
                        <img src="./../vet/vet_img/<?php echo $image_row['image'] ?>"
                        ...
                        <div class="product-details">
                            ...
                            <div class="not_change_on_hover">
                                <div class="product-quality">
                                    ...
                                    <a href="vetbooking.php?uid=<?php echo $row1['userid'] ?>"> <button
