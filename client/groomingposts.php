    ...
    <div class="posts" >
      <div class="product-card" id="product-card">
          ...
          <div class="product-details">
              ...
              <div class="product-card" id="product-card">
                ...
                <div class="product-details">
                    ...
                    <div class="product-card" id="product-card">
                      <img src="../images/groom5.jpg" class="product-card-thumbnail-image">
                      <div class="swiper-container">
                          <div class="swiper-wrapper">
                              <div class="swiper-slide">
                                  <img class="scale-down" src="../images/groom3.jpg">
                              </div>
                              <div class="swiper-slide">
                                  <img class="scale-down" src="https://images.unsplash.com/photo-1470859624578-4bb57890378a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80">
                              </div>
                      ...
                      <div class="product-details">
                          <div id="hide_on_hover">
                              <p class="book-title">scissors Groomers</p>
                              <p class="author"></p>
                              <span class="rating"> 4.5
                                    <p class="fa fa-star"></p> (124)
                              </span>
                          ...
                          <div class="product-card" id="product-card">
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-card" id="product-card">
                                  ...
                                  <div class="product-details">
                                      <div id="hide_on_hover">
                                          <p class="book-title">MEW Groomers</p>
                                          <p class="author"></p>
                                          <span class="rating"> 4.5
                                                <p class="fa fa-star"></p> (124)
                                          </span>
        ...
        <div class="product-card" id="product-card">
            ...
            <div class="product-details">
                <div id="hide_on_hover">
                    <p class="book-title">Happy Dog Groomers</p>
                    <p class="author"></p>
                    <span class="rating"> 4.5
                          <p class="fa fa-star"></p> (124)
                    </span>
