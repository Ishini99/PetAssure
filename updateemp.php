...
<?php
     include "db.php";
        $userid = $_POST['empid'];
    $sql = "SELECT `empid`, `emp_name`, `nic`, `address`, `mobile` FROM `employees` WHERE `empid`='$userid'";
...
<input type="hidden" name='empid' value='<?php echo $userid?>' required>
</div>
<div class="input-box">
  <input type="text" name='uname' value='<?php echo $row['emp_name']?>' required>
</div>
<div class="input-box">
