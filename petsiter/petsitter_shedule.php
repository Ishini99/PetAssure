...
<head>
    ...
    <link rel="stylesheet" href="../css/petsitter_appointments.css">
        ...
        <tr >
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <div class="heading-main12" style="margin-left: 45px;font-size:23px;color:rgb(49, 49, 49);margin-top: -55px;"
...
<!-- appointment table-->
            ...
            <table class="styled-table">
                ...
                <?php
                    ...
                    <td><button class="login-btn btn-primary btn button-icon"" style="height:30px;" >View<button></td>
                    <td></td>
                    <td>
                 <center>
