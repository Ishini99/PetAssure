...
if(isset($_POST["submit"])){
    ...
    if($_FILES["image"]["error"] == 4){
      ...
      if ( !in_array($imageExtension, $validImageExtension) ){
        ...
        move_uploaded_file($tmpName, 'boarding_img/' . $newImageName);
        $query = "INSERT INTO boardingimage (name, image,uid) VALUES('$name', '$newImageName','$userid')";
...
if(isset($_POST["delete"])){
    ...
    if (!isset($imgId) || !is_numeric($imgId)) {
        ...
        $query = "DELETE FROM boardingimage WHERE imgId = $imgId";
        mysqli_query($con, $query);
        unlink("boarding_img/" . $imageName); // delete the image file from server
...
<body class="profile-page">
    <div class="nav" style="width: 100%;">
        ...
        <div class="right">
            ...
            <a href="petboarding-Dashboard.php" class="font">DASHBOARD</a>
    ...
    <div class="center">
      ...
      foreach ($rows as $row) :
        ?>
                    <td>
                        <img src="boarding_img/<?php echo $row["image"]; ?>" width=100 height=150
